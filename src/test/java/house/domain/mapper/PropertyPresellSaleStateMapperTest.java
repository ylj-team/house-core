...
public class PropertyPresellSaleStateMapperTest {
	...
	public static void testQueryHouseSaleStateByPropertyPresellIdAndStateChangeTime() {
		...
		List<PropertyPresellSaleState> propertyPresellSaleStates = mapper.queryPresellSaleStateByPropertyPresellIdAndStateChangeTime(propertyId, presellId, stateChangeTimeBegin, stateChangeTimeEnd);
	...
	public static void testQueryHouseSaleStateByPropertyIdAndStateChangeTime() {
		...
		String propertyId = "64897079";
		String stateChangeTimeBegin = "2014-01-31 00:00:00";
		String stateChangeTimeEnd = "2016-03-05 24:00:00";
		List<PropertyPresellSaleState> propertyPresellSaleStates = mapper.queryPresellSaleStateByPropertyIdAndStateChangeTime(propertyId, stateChangeTimeBegin, stateChangeTimeEnd);
	...
	public static void testQueryHouseSaleStateByPropertyId() {
		SqlSession sqlSession = sqlSessionFactory.openSession();
		// 创建Usermapper对象，mybatis自动生成mapper代理对象
		PropertyPresellSaleStateMapper mapper = sqlSession.getMapper(PropertyPresellSaleStateMapper.class);
		...
		List<PropertyPresellSaleState> propertyPresellSaleStates = mapper.queryPresellSaleStateByPropertyId(propertyId);
	...
	//	testQueryHouseSaleStateByPropertyIdAndStateChangeTime();
		...
		testQueryHouseSaleStateByPropertyId();
	}
}
